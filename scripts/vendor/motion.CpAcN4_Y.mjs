import { r as e, t } from "./rolldown-runtime.CawJvvTp.mjs";
import {
  A as n,
  C as r,
  F as i,
...
function Re(e, t) {
  let n = !1,
    ...
    a = () => (n = !0),
    o = cc.reduce((e, n) => ((e[n] = Le(a, t ? n : void 0)), e), {}),
    {
      setup: s,
      read: c,
      resolveKeyframes: l,
...
function Je(e) {
  let t = We(e);
  return Ke(t)(t.values.map((e, n) => Wc(e, t.split[n])));
}
function Ye(e, t, n) {
  return (
    n < 0 && (n += 1),
...
function ut({
  ...
  let i, a;
  Ns(e <= L(Y.maxDuration), `Spring duration must be 10 seconds or less`, `spring-duration-limit`);
  let o = 1 - t;
...
function pt(e = Y.visualDuration, t = Y.bounce) {
  ...
  let w = {
    ...
    toString: () => {
      let e = Math.min(ot(w), Qc),
        t = Zc((t) => w.next(e * t).value, e, 30);
      return e + `ms ` + t;
    },
    toTransition: () => {},
  };
...
function zt({ type: e, ...t }) {
  return Rt(e) && Pl() ? e.applyToOptions(t) : ((t.duration ??= 300), (t.ease ??= `easeOut`), t);
}
function Bt(e) {
  return e in Rl;
}
function Vt(e) {
  typeof e.ease == `string` && Bt(e.ease) && (e.ease = Rl[e.ease]);
}
function Ht(e) {
...
function Xt(e, t, n = 1) {
  ...
  if (a) {
    let e = a.trim();
    return Ps(e) ? parseFloat(e) : e;
  }
  return gc(i) ? Xt(i, t, n + 1) : i;
}
function Zt(e, t) {
  if (e?.inherit && t) {
    let { inherit: n, ...r } = e;
...
function fn(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  for (let t in s) {
    ...
    if (T.MotionHandoffAnimation) {
      let n = un(e);
      if (n) {
        let e = T.MotionHandoffAnimation(n, t, B);
...
function yn(e, t, n) {
  ...
  for (; r < e.length && !i; ) {
    let t = e[r];
    (typeof t == `string` && !Eu.has(t) && We(t).values.length && (i = e[r]), r++);
  }
...
function xn(e) {
  return Fs(e) && `offsetHeight` in e && !(`ownerSVGElement` in e);
}
function Sn() {
  return Z.x || Z.y;
}
  ...
  let [r, i, a] = wn(e, n),
    o = (e) => {
      ...
      let a = t(r, e),
        ...
        s = (e) => {
          o(e, r === T || r === document || n.useGlobalTarget || ju(r, e.target));
        },
        c = (e) => {
          o(e, !1);
        };
      (T.addEventListener(`pointerup`, s, i), T.addEventListener(`pointercancel`, c, i));
    };
  return (
    r.forEach((e) => {
...
function In() {
  typeof ResizeObserver > `u` || (zu = new ResizeObserver(Fn));
}
function Ln(e, t) {
  zu || In();
  let n = bn(e);
...
function Kn(e, t, n = {}) {
  ...
  if (
    (e.attach((e, t) => {
      ((a = e), (o = (e) => t(qn(e, s))), B.postRender(u));
    }, c),
    X(t))
  ) {
...
function $n(e) {
  return Zn(e.animate) || Qu.some((t) => Qn(e[t]));
}
function er(e) {
...
function Pr(e, t, n, r) {
  for (let n in (Tr(e, t, void 0, r), t.attrs)) e.setAttribute(yd.has(n) ? n : ln(n), t.attrs[n]);
}
function Fr(e, t, n) {
  let r = kr(e, t, n);
  for (let n in e)
...
function ti(e, t, n, r) {
  (ei(e.x, t, jd, n ? n.x : void 0, r ? r.x : void 0),
    ei(e.y, t, Md, n ? n.y : void 0, r ? r.y : void 0));
}
function ni(e) {
...
function pi(e, t, n) {
  return (r) => (r < e ? 0 : r > t ? 1 : n(Rs(e, t, r)));
}
function mi(e, t, n) {
  let r = X(e) ? e : D(e);
...
function yi(e) {
  ...
  if (T.MotionHasOptimisedAnimation(n, `transform`)) {
    ...
    T.MotionCancelOptimisedAnimation(n, `transform`, B, !(t || r));
  }
  let { parent: r } = e;
...
function bi({
  ...
  return class {
    ...
    addEventListener(e, t) {
      return (
        this.eventHandlers.has(e) || this.eventHandlers.set(e, new zs()),
          ...
          e(t, () => {
            ...
            e !== r &&
              ...
              Hd.hasAnimatedSinceResize &&
                ((Hd.hasAnimatedSinceResize = !1), this.nodes.forEach(ji)));
          }));
      }
    ...
    willUpdate(e = !0) {
      ...
      if (
        (T.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && yi(this),
    ...
    setAnimationOrigin(e, t = !1) {
      ...
      let o = Q(),
        ...
        u = !!(s && !l && this.options.crossfade === !0 && !this.path.some(zi));
      this.animationProgress = 0;
      let d;
      ((this.mixTargetDelta = (t) => {
        ...
        (Ii(a.x, e.x, n),
          ...
          this.relativeTarget &&
            ...
            Ri(this.relativeTarget, this.relativeTargetOrigin, o, n),
            d && ai(this.relativeTarget, d) && (this.isProjectionDirty = !1),
            (d ||= Q()),
            k(d, this.relativeTarget)),
          s && ((this.animationValues = i), di(i, r, this.latestValues, n, u, l)),
    ...
    resetSkewAndRotation() {
      ...
      for (let t = 0; t < Wd.length; t++)
        (vi(`rotate${Wd[t]}`, e, r, this.animationValues),
          vi(`skew${Wd[t]}`, e, r, this.animationValues));
...
function ia(e) {
  typeof e == `function` && (pf = (t) => (t.startsWith(`on`) ? !ra(t) : e(t)));
}
function aa(e, t, n) {
  let r = {};
  for (let i in e)
...
function oa({ children: e, isValidProp: t, ...r }) {
  ...
  return h($.Provider, { value: a, children: e });
}
...
function ua(e) {
  let { initial: t, animate: r } = la(e, n(mf));
...
function ga(e, t, n, r) {
  let i = v(() => {
    let n = vf();
    return (Nr(n, t, bd(r), e.transformTemplate, e.style), { ...n.attrs, style: { ...n.style } });
  }, [t]);
  if (e.style) {
    let t = {};
...
function wa(e, { forwardMotionProps: t = !1, type: r } = {}, i, a) {
  ...
  function c(r, c) {
    ...
    return b(mf.Provider, {
      value: f,
      children: [
        l && f.visualElement ? h(l, { visualElement: f.visualElement, ...u }) : null,
...
function Ua(e, t) {
  let n = 0.5,
    ...
    i = A(t);
  return (
    i > r ? (n = Rs(t.min, t.max - r, e.min)) : r > i && (n = Rs(e.min, e.max - i, t.min)),
    N(0, 1, n)
  );
}
function Wa(e, t) {
...
function Qa(e) {
  let [t, r] = Xi(),
    i = n(ks);
  return h(Bf, { ...e, layoutGroup: i, switchLayoutGroup: n(gf), isPresent: t, safeToRemove: r });
}
function $a(e, t, n) {
  let { props: r } = e;
  e.animationState && r.whileHover && e.animationState.setActive(`whileHover`, n === `Start`);
  let i = r[`onHover` + n];
  i && B.postRender(() => i(t, ka(t)));
}
function eo(e, t, n) {
  let { props: r } = e;
...
function io(e, t, n, r) {
  ...
  ((i.current = Math.abs(e[`scroll${o}`])),
    ...
    (i.progress = Rs(0, i.scrollLength, i.current)));
  let l = r - c;
  i.velocity = l > tp ? 0 : Bs(i.current - s, l);
}
function ao(e, t, n) {
...
function mo(e, { container: t = document.scrollingElement, trackContentSize: n = !1, ...r } = {}) {
  ...
  if ((i.add(a), !lp.has(t))) {
    ...
    (T.addEventListener(`resize`, r),
      t !== document.documentElement && up.set(t, Bn(t, r)),
...
function yo(e) {
  ...
  for (let [t, n] of hp) if (vo(e, t)) return { rangeStart: `${n} 0%`, rangeEnd: `${n} 100%` };
}
function bo(e) {
  let t = { value: 0 };
  return {
...
function Oo(e, t) {
  return T === void 0 ? !1 : e ? Nl() && !!yo(t) : Ml();
}
    ...
    c(() => {
      ...
      let n,
        r = () => {
          let r = yp(e),
            i = yp(t);
          (P(!r, `Container ref is defined but not hydrated`, `use-scroll-ref`),
            P(!i, `Target ref is defined but not hydrated`, `use-scroll-ref`),
            !r && !i && (n = o()));
        };
      return (
        ku.read(r),
      ...
      _ = (e, n, r, o = 0, s = 0) => {
        ...
        if (
          ...
          m &&
            Ns(
              m < Sp,
              `Sequence segments can't repeat ${m} times \u2014 ignoring repeat option. Use a value below ${Sp} or apply repeat at the sequence level instead.`
            ),
          m && m < Sp)
        ) {
          let e = b > 0 ? _ / b : 0;
          ...
          i &&
            ((a = [...t].reverse()),
            h === `reverse` &&
              (o = [...r].reverse().map((e) => (typeof e == `function` ? Ks(e) : e))));
          for (let s = 0; s < m; s++) {
            let l = i && s % 2 == 0,
              d = l ? a : t,
              f = l ? o : r,
        ...
        let T = ee + b;
        (Yo(r, c, y, u, ee, T), (g = Math.max(x + b, g)), (f = Math.max(T, f)));
      };
    if (X(p)) {
      let e = $o(p, s);
      _(m, h, es(`default`, e));
    ...
    s.forEach((e, r) => {
      for (let i in e) {
        ...
        for (let e = 0; e < a.length; e++) {
          ...
          (s.push(n), c.push(Rs(0, f, t)), l.push(r || `easeOut`));
        }
...
function _s(e, { root: t, margin: n, amount: r, once: a = !1, initial: o = !1 } = {}) {
  let [s, l] = i(o);
  return (
    c(() => {
...
function bs({ children: e, as: t = `ul`, axis: n = `y`, onReorder: r, values: i, ...a }, o) {
  let s = M(() => $f[t]),
    ...
    d = l(!1),
    f = l(null);
  P(!!i, `Reorder.Group must be provided a values prop`, `reorder-values`);
  let p = {
    axis: n,
    groupRef: f,
    registerItem: (e, t) => {
  ...
  return h(s, {
    ...
    ref: m,
    ignoreStrict: !0,
    children: h(Ap.Provider, { value: p, children: e }),
  });
}
function xs(e, t) {
...
function Es(e, t, n, r) {
  ...
  let i = ws(e, n);
  if (!i) return;
  let { amount: a, edge: o } = Ts(t - (n === `x` ? T.scrollX : T.scrollY), i, n);
  if (o === null) {
...
function Os(
  ...
  P(!!d, `Reorder.Item must be a child of Reorder.Group`, `reorder-item-child`);
  let { axis: m, registerItem: g, updateOrder: _, groupRef: v } = d;
  return h(u, {
    drag: m,
    ...c,
    dragSnapToOrigin: !0,
    ...
    onDrag: (e, t) => {
      ...
      (_(r, f[m].get(), n[m]), Es(v.current, i[m], m, n[m]), a && a(e, t));
    },
    onDragEnd: (e, t) => {
      (Ss(), o && o(e, t));
    },
...
var ks,
  ...
  zp = t(() => {
    (o(),
      ...
      (kc = { test: wc(`#`), parse: He, transform: Oc.transform }),
      (Ac = (e) => ({
      ...
      (ol = { decay: ht, inertia: ht, tween: St, keyframes: St, spring: pt }),
      (sl = class {
        constructor() {
          this.updateFinished();
        }
      ...
      (ll = class extends sl {
        ...
        initAnimation() {
          ...
          s !== St &&
            typeof o[0] != `number` &&
            ((this.mixKeyframes = Ls(cl, at(o[0], o[1]))), (o = [0, 100]));
      ...
      (kl = class {
        ...
        scheduleResolve() {
          ((this.state = `scheduled`),
            this.isAsync
              ? (Tl.add(this), El || ((El = !0), B.read(Mt), B.resolveKeyframes(jt)))
      ...
      (Al = (e) => e.startsWith(`--`)),
      (jl = {}),
      (Ml = Ft(() => T.ScrollTimeline !== void 0, `scrollTimeline`)),
      (Nl = Ft(() => T.ViewTimeline !== void 0, `viewTimeline`)),
      (Pl = Ft(() => {
        try {
      ...
      (Wl = Ne(() => Object.hasOwnProperty.call(Element.prototype, `animate`))),
      (Gl = (e, t) =>
        t === `zIndex`
          ? !1
          : !!(
      ...
      (lu = class {
        ...
        on(e, t) {
          this.events[e] || (this.events[e] = new zs());
        ...
        getVelocity() {
          ...
          return Bs(parseFloat(this.current) - parseFloat(this.prevFrameValue), t);
        }
        start(e) {
          return (
            this.stop(),
      ...
      ({ schedule: ku, cancel: Au } = Re(queueMicrotask, !1)),
      (Z = { x: !1, y: !1 }),
      ...
      (id = class {
          ...
          ((this.current = e),
            ...
            this.reducedMotionConfig === `never`
              ...
              : this.reducedMotionConfig === `always`
                ...
                : (ed.current || nr(), (this.shouldReduceMotion = $u.current)),
        ...
        readValue(e, t) {
          ...
          return (
            n != null &&
              (typeof n == `string` && (Ps(n) || Is(n))
                ? (n = parseFloat(n))
                : !Ku(n) && q.test(t) && (n = _n(e, t)),
        ...
        on(e, t) {
          return (this.events[e] || (this.events[e] = new zs()), this.events[e].add(t));
        }
        notify(e, ...t) {
      ...
      (md = class extends ad {
        ...
        readValueFromInstance(e, t) {
          if (bl.has(t)) return this.projection?.isProjecting ? Dt(t) : vl(e, t);
          {
            let n = Ar(e),
      ...
      (xd = class extends ad {
        ...
        readValueFromInstance(e, t) {
          ...
          return ((t = yd.has(t) ? t : ln(t)), e.getAttribute(t));
        }
        scrapeMotionValuesFromProps(e, t, n) {
          return Fr(e, t, n);
        }
      ...
      (tf = ({
        ...
        return (
          ...
          h(Ms.Provider, { value: m, children: e })
        );
      }),
      (nf = (e) => e.key || ``),
      (rf = ({
        ...
        if (g !== ee) {
          ...
          return (s === `wait` && E.length && (e = E), te(Zi(e)), w(g), null);
        }
        let { forceRender: ne } = n(ks);
        return h(S, {
          children: T.map((e) => {
            let n = nf(e),
      ...
      (cf = ({ children: e, id: t, inherit: r = !0 }) => {
        ...
        c.current === null &&
          (sf(r) && u && (t = t ? u + `-` + t : u),
          (c.current = { id: t, group: (of(r) && i.group) || Wi() }));
        let d = v(() => ({ ...c.current, forceRender: o }), [s]);
        return h(ks.Provider, { value: d, children: e });
      }),
      (lf = a({ strict: !1 })),
      (uf = {
        animation: [
    ...
    ((mf = a({})),
      ...
      (bf = hf({ scrapeMotionValuesFromProps: kr, createRenderState: _f })),
      (xf = hf({ scrapeMotionValuesFromProps: Fr, createRenderState: vf })),
      ...
      (Df = (e) => (t) => Mu(t) && e(t, ka(t))),
      (Of = (e, t) => Math.abs(e - t)),
      (kf = (e, t) => ((t.isSVG ?? _a(e)) ? new xd(t) : new md(t, { allowProjection: e !== u }))),
        ...
        constructor(
          ...
          (u && u(e, Pa(s, this.history)),
            (this.removeListeners = Ls(
              Aa(this.contextWindow, `pointermove`, this.handlePointerMove),
              Aa(this.contextWindow, `pointerup`, this.handlePointerUp),
              Aa(this.contextWindow, `pointercancel`, this.handlePointerUp)
            )),
      ...
      (Ff = class {
        ...
        startAxisValueAnimation(e, t) {
          ...
          return (cn(this.visualElement, e), n.start(iu(e, n, 0, t, this.visualElement, !1)));
        }
        stopAnimation() {
        ...
        addListeners() {
          ...
          let o = hi(T, `resize`, () => this.scalePositionWithinConstraints()),
      ...
      (Vf = { pan: { Feature: Rf }, drag: { Feature: If, ProjectionNode: $d, MeasureLayout: Qa } }),
      (Hf = class extends od {
        mount() {
      ...
      (Xf = class extends od {
        ...
        startObserver() {
          ...
          this.stopObserver = no(this.node.current, a, (e) => {
      ...
      (Qf = { layout: { ProjectionNode: $d, MeasureLayout: Qa } }),
      ($f = Oa({ ...Ef, ...Zf, ...Vf, ...Qf }, kf)),
...
//# sourceMappingURL=motion.CpAcN4_Y.mjs.map
