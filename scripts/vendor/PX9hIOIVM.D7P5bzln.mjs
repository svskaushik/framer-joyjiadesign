...
import { S as p, a as m, r as ne, t as re } from "./motion.CpAcN4_Y.mjs";
import {
  A as h,
  At as ie,
  Dt as g,
...
e(() => {
  (l(),
    ...
    (K = y(G)),
    (q = y(I)),
    (J = v(I, { nodeId: `pBR1Ew0r8`, override: fe, scopeId: `PX9hIOIVM` })),
    (Y = ie(x(v(p.a, { nodeId: `HK2sXlagE`, override: de, scopeId: `PX9hIOIVM` })))),
    (X = `framer-6jWyo`),
    ...
    (Q = g(
      a(function (e, t) {
        let n = r(null),
          i = t ?? n,
          a = te(),
          { activeLocale: o, setLocale: ee } = le();
        ce();
        let { style: l, className: u, layoutId: d, variant: f, ...m } = Ce(e),
          {
            ...
            setVariant: se,
            variants: x,
          } = ae({ defaultVariant: `HK2sXlagE`, ref: i, variant: f, variantClassNames: ge }),
          S = we(e, x),
          C = _(X);
        return s(ne, {
          id: d ?? a,
            ...
            children: s(Se, {
              ...
              children: s(oe, {
                ...
                children: c(Y, {
                  ...
                  __targetOpacity: 1,
                  className: `${_(C, `framer-n0ccwk`, u, h)} framer-bmpgw8`,
    ...
    se(Q, [{ explicitInter: !0, fonts: [] }, ...K, ...q], { supportsExplicitInterCodegen: !0 }),
    ($ = {
      exports: {
...
//# sourceMappingURL=PX9hIOIVM.D7P5bzln.mjs.map
