...
import { a as de, c as fe, i as pe, o as L, r as R, s as z } from "./shared-lib.Dqp23CCf.mjs";
import { n as B, t as V } from "./TwJkpe0RQ.CZtQ7Gfn.mjs";
import { n as H, t as me } from "./tL73CBK8h.3AGeDc7I.mjs";
import { n as he, t as ge } from "./K1UDmAL9B.9vbflJSV.mjs";
import { i as _e, r as ve } from "./nOXL0BeXe.LC0aDWbL.mjs";
import { i as ye, n as be, r as xe, t as Se } from "./VwJ5pWYb7.DNwZne6r.mjs";
import { n as Ce, r as we } from "./IFvtpR9s0.D0bhRps3.mjs";
function Te(e, ...t) {
  let n = {};
...
var Ee,
  ...
  Fe = e(() => {
    (c(),
      ...
      (Ae = { bounce: 0, delay: 0, duration: 0.4, type: `spring` }),
      ...
      (W = _(
        i(function (e, t) {
          let i = n(null),
            o = t ?? i,
            s = te(),
            { activeLocale: c, setLocale: ee } = ie();
          j();
          let {
              style: l,
              className: d,
            ...
            D = Pe(e, E),
            { activeVariantCallback: O, delay: k } = se(v),
            A = O(async (...e) => {
            ...
            children: a(U, {
              ...
              children: a(je, {
                ...
                children: a(u.div, {
                  ..._,
                  ...S,
                  className: y(M, `framer-15f26z8`, d, b),
                  "data-border": !0,
      ...
      m(W, {
        ...
        onmXpY5N3RAChange: { changes: `mXpY5N3RA`, type: F.ChangeHandler },
        eAHGXWjyh: { title: `Click`, type: F.EventHandler },
      }),
      k(
        W,
        [
...
e(() => {
  (c(),
    ...
    (Y = ({ query: e, pageSize: t, children: n }) => n(I(e))),
    ...
    ($ = _(
      i(function (e, i) {
        let c = n(null),
          l = i ?? c,
          p = te(),
          { activeLocale: m, setLocale: _ } = ie(),
          v = j(),
          [x, S] = ae({ collectionId: `K1UDmAL9B`, optional: !0, parameterName: `service` }),
          { style: C, className: w, layoutId: O, variant: k, ...A } = et(e);
        ce(t(() => we({}, m), [m]));
        let [P, F] = oe(k, Ve, !1),
          { activeVariantCallback: I, delay: de } = se(void 0),
          fe = I(async (...e) => {
            S?.(void 0);
          }),
          pe = ({ arg10ntkyo: e }) =>
          ...
          L = y(Ue, Se),
          z = o(E)?.isLayoutTemplate,
          B = Ge(z, !!o(d)?.transition?.layout),
          V = re(`XYvp9zth0`),
          me = le();
        return (
          h(),
                                                  ...
                                                  children: a(ue.Provider, {
                                                    ...
                                                    children: a(T, {
                                                      ...
                                                      children: a(N, {
                                                        ...
                                                        scopeId: `IFvtpR9s0`,
                                                        children: a(G, {
                                                          eAHGXWjyh: pe({ arg10ntkyo: n }),
                                                          height: `100%`,
                                                          id: `ZlONvbIXK`,
                                                          layoutId: `ZlONvbIXK`,
                                                          mXpY5N3RA: t,
                                                          variant: q(Ye(Je(x, n), m)),
                                                          width: `100%`,
                                                        }),
                                                      }),
                                                    }),
                                                ...
                                                children: a(g, {
                                                  ...
                                                  children: (n) =>
                                                    a(b, {
                                                      ...
                                                      overrides: {
                                                        ed_UntlQA: {
                                                          width: `max((min(${v?.width || `100vw`} - 40px, 1920px) - 100px) / 2, 50px)`,
                                                        },
                                                        YzcQdhUUh: {
                                                          width: `max(min(${v?.width || `100vw`} - 40px, 1920px) - 40px, 50px)`,
                                                        },
                                                      },
                                                      children: a(T, {
                                                        height: 532,
                                                        width: `max((min(${v?.width || `100vw`} - 40px, 1920px) - 120px) / 3, 50px)`,
                                                        children: a(Re, {
                                                          animate: {
                                                            opacity: 1,
                                                            rotate: 0,
    ...
    ($.loader = {
      load: (e, t) => {
        ...
        return Promise.allSettled([
          i.preload(),
          r.then(({ cFjtK6LzP1: e }) => P.get(Z(e), n).preload()),
          v(R, {}, t),
          (async () => {
            let e = (await i.readMaybeAsync()) ?? [];
            return Promise.allSettled(e.flatMap((e) => [v(G, {}, t), v(G, {}, t)]));
          })(),
          (async () => {
            let { cFjtK6LzP1: e } = await r,
              i = (await P.get(Z(e), n).readMaybeAsync()) ?? [];
            return Promise.allSettled(i.flatMap((e) => v(H, {}, t)));
          })(),
        ]);
      },
    }),
...
//# sourceMappingURL=0qvNRaT5lXhZh1KJk-SG8s-ds_0_2cdLtgR71PSZVSI.BnuX3iPC.mjs.map
