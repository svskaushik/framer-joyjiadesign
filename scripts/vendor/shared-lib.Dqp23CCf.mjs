...
import { S as v, a as y, r as b, t as x } from "./motion.BEaCLYSy.mjs";
import {
  A as S,
  Et as ee,
  N as C,
      ...
      (P = class {
        ...
        advance(e) {
          ...
          if (this.duration && this.easing) {
            this.currentTime += e;
            let n = M(0, this.currentTime / this.duration, 1);
            t = n >= 1;
            let r = t ? 1 : this.easing(n);
            this.value = this.from + (this.to - this.from) * r;
          } else
            this.lerp
              ? ((this.value = ce(this.value, this.to, this.lerp * 60, e)),
      ...
      (F = class {
        constructor(e, t, { autoResize: n = !0, debounce: r = 250 } = {}) {
          ((this.wrapper = e),
            (this.content = t),
            n &&
              ((this.debouncedResize = ue(this.resize, r)),
      ...
      (z = class {
        ...
        onWheel = (e) => {
          let { deltaX: t, deltaY: n, deltaMode: r } = e,
            i = r === 1 ? L : r === 2 ? this.window.width : 1,
            a = r === 1 ? L : r === 2 ? this.window.height : 1;
          ((t *= i),
            (n *= a),
        ...
        onWindowResize = () => {
          this.window = { width: s.innerWidth, height: s.innerHeight };
        };
      }),
      (B = (e) => Math.min(1, 1.001 - 2 ** (-10 * e))),
      (V = class {
        _isScrolling = !1;
        _isStopped = !1;
        _isLocked = !1;
        ...
        constructor({
          ...
          ((s.lenisVersion = N),
            (!e || e === document.documentElement) && (e = s),
            ...
            (this.dimensions = new F(e, t, { autoResize: g })),
            ...
            (this.virtualScroll = new z(n, { touchMultiplier: m, wheelMultiplier: h })),
        ...
        dispatchScrollendEvent = () => {
          this.options.wrapper.dispatchEvent(
            new CustomEvent(`scrollend`, {
              bubbles: this.options.wrapper === s,
        ...
        onClick = (e) => {
          ...
          this.options.stopInertiaOnNavigate &&
            t.find((e) => e.host === s.location.host) &&
            this.reset();
        };
        onPointerDown = (e) => {
        ...
        scrollTo(
          e,
          {
            ...
            easing: c = i ? this.options.easing : void 0,
            onStart: l,
            onComplete: u,
            force: d = !1,
            userData: f,
          ...
          if (!((this.isStopped || this.isLocked) && !d)) {
            ...
            if (typeof e == `number`) {
              ...
              (i || (this.targetScroll = e),
                typeof o == `number` && typeof c != `function`
                  ? (c = B)
                  : typeof c == `function` && typeof o != `number` && (o = 1),
        ...
        checkNestedScroll(e, { deltaX: t, deltaY: n }) {
          let r = Date.now(),
            ...
            f,
            p,
            m = this.options.gestureOrientation;
          if (r - (i.time ?? 0) > 2e3) {
            i.time = Date.now();
            ...
            if (
              ...
              (i.hasOverflowX = a),
              (i.hasOverflowY = o),
              (!a && !o) || (m === `vertical` && !o) || (m === `horizontal` && !a))
            )
              return !1;
            ((u = e.scrollWidth),
              (d = e.scrollHeight),
          ...
          if (!h) return !1;
          let g, _, v, y, b;
          if (h === `x`) ((g = e.scrollLeft), (_ = u - f), (v = t), (y = a), (b = c));
          else if (h === `y`) ((g = e.scrollTop), (_ = d - p), (v = n), (y = o), (b = l));
          else return !1;
          return (v > 0 ? g < _ : g > 0) && y && b;
        }
        get rootElement() {
        ...
        get scroll() {
          return this.options.infinite ? le(this.animatedScroll, this.limit) : this.animatedScroll;
        }
        get progress() {
...
function W(e) {
  (e?.dataset?.sticky === `true` && (e.style.removeProperty(`position`), delete e.dataset.sticky),
    e.offsetParent && W(e.offsetParent));
}
function G(e, t = 0) {
  let n = t + e.offsetTop;
...
function K(e, t = 0) {
  ...
  return e.offsetParent ? K(e.offsetParent, n) : n;
}
function q(e, t = 0) {
  let n = t + e.scrollTop;
  return e.offsetParent ? q(e.offsetParent, n) : n + s.scrollY;
}
function J(e, t = 0) {
  let n = t + e.scrollLeft;
  return e.offsetParent ? J(e.offsetParent, n) : n + s.scrollX;
}
function Y() {
  return pe++;
}
      ...
      (fe = class {
        ...
        constructor(
          ...
          ((this.element = e),
            ...
            (this.align = [t].flat()),
            (this.debouncedWrapperResize = H(this.onWrapperResize, 500)),
        ...
        onWrapperResize = () => {
          let e, t;
          if ((this.options.ignoreSticky && U(this.element), this.options.ignoreTransform))
            ((e = G(this.element)), (t = K(this.element)));
          else {
            let n = this.element.getBoundingClientRect();
            ((e = n.top + q(this.element)), (t = n.left + J(this.element)));
          }
          (this.options.ignoreSticky && W(this.element), this.setRect({ top: e, left: t }));
        };
        onResize = ([e]) => {
      ...
      (me = class {
        constructor(
          ...
          ((this.lenis = e),
            ...
            this.onWindowResize(),
            s.addEventListener(`resize`, this.onWindowResize, !1),
            (this.onSnapDebounced = H(this.onSnap, this.options.debounce)),
        ...
        addElement(e, t = {}) {
          let n = Y();
          return (this.elements.set(n, new fe(e, t)), () => this.elements.delete(n));
        }
        addElements(e, t = {}) {
        ...
        onWindowResize = () => {
          ((this.viewport.width = s.innerWidth), (this.viewport.height = s.innerHeight));
        };
        computeSnaps = () => {
...
function X({ smooth: e, infinite: t, orientation: r, intensity: a, children: l, snap: f }) {
  let m = n(),
    g = n(),
    _ = n();
  return (
    i(() => {
      if (l && (!m.current || !g.current)) return;
      m.current &&
        g.current &&
        (r === `horizontal`
          ? m.current.style.setProperty(`overflowX`, `auto`)
          : m.current.style.setProperty(`overflowY`, `auto`));
      let n = new V({
        smoothWheel: e,
        infinite: t,
        orientation: r,
        gestureOrientation: r === `horizontal` ? `both` : `vertical`,
        autoRaf: !0,
        autoToggle: !0,
        anchors: !0,
        allowNestedScroll: !0,
      ...
      return (
        f &&
          f.snaps.length > 0 &&
          ((i = new me(n, { type: f.type, distanceThreshold: f.threshold + `%` })),
          f.snaps.forEach((e) => {
    ...
    p(h, {
      children: [
        u(`link`, { href: `../../assets/misc/lenis.css`, rel: `stylesheet` }),
        l &&
          u(h, {
            children: u(`div`, {
              ref: m,
              ...
              children: u(`div`, {
                ...
                style: { width: `100%` },
                children: c.map(l, (e) =>
                  d(e) ? o(e, { style: { ...e.props.style, width: `100%` } }) : e
                ),
              }),
            }),
          }),
...
var ge = e(() => {
    (r(),
      ...
      (X.displayName = `Lenis`),
      S(X, {
        smooth: { type: O.Boolean, title: `Smooth`, defaultValue: !0 },
        intensity: {
          type: O.Number,
          title: `Intensity`,
          defaultValue: 12,
        ...
        children: { type: O.ComponentInstance, title: `Content` },
        snap: {
          type: O.Object,
          optional: !0,
          ...
          controls: {
            ...
            snaps: {
              ...
              control: {
                type: O.Object,
                controls: {
                  target: { title: `Target`, type: O.ScrollSectionRef },
                  align: {
                    type: O.Enum,
                    defaultValue: `center`,
                    displaySegmentedControl: !0,
    ...
    (m(),
      ...
      (Q = ee(
        l(function (e, t) {
          ...
          ae();
          let { style: c, className: l, layoutId: d, variant: f, ...p } = Z(e),
            {
              baseVariant: m,
              classNames: h,
              ...
              setVariant: T,
              variants: E,
            } = te({ defaultVariant: `EiDNqBa0C`, ref: i, variant: f, variantClassNames: ye }),
            D = Ce(e, E),
            ie = C(ve);
          return u(b, {
            id: d ?? a,
            children: u(Se, {
              ...
              children: u(xe, {
                ...
                children: u(v.div, {
                  ...p,
                  ...y,
                  className: C(ie, `framer-1jj4ft`, l, h),
...
var Ee = e(() => {});
export { j as a, oe as c, we as i, Te as n, A as o, $ as r, k as s, Ee as t };
//# sourceMappingURL=shared-lib.Dqp23CCf.mjs.map
