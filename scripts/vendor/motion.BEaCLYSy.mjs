import { r as e, t } from "./rolldown-runtime.TjgygFMs.mjs";
import {
  A as n,
  C as r,
  D as i,
...
function Ie(e, t, n, r, i) {
  let a,
    o,
    s = 0;
  do ((o = t + (n - t) / 2), (a = Hs(o, r, i) - e), a > 0 ? (n = o) : (t = o));
  while (Math.abs(a) > Us && ++s < Ws);
  return o;
}
function Le(e, t, n, r) {
  if (e === t && n === r) return I;
  let i = (t) => Ie(t, 0, 1, e, n);
  return (e) => (e === 0 || e === 1 ? e : Hs(i(e), t, r));
}
function Re(e, t) {
  return rc(e) ? e[Vs(0, e.length, t)] : e;
}
function ze(e, t) {
  let n = new Set(),
    r = new Set(),
  ...
  let u = {
    ...
    process: (e) => {
      ...
      ((n = r),
        (r = o),
        n.forEach(l),
        t && z.value && z.value.frameloop[t].push(c),
        (c = 0),
        n.clear(),
        (i = !1),
        a && ((a = !1), u.process(e)));
...
function Be(e, t) {
  let n = !1,
    ...
    a = () => (n = !0),
    o = cc.reduce((e, n) => ((e[n] = ze(a, t ? n : void 0)), e), {}),
    {
      setup: s,
      read: c,
      resolveKeyframes: l,
    ...
    h = () => {
      ...
      ((n = !1),
        a || (i.delta = r ? 1e3 / 60 : Math.max(Math.min(o - i.timestamp, lc), 1)),
        (i.timestamp = o),
        (i.isProcessing = !0),
        s.process(i),
        c.process(i),
  ...
  return {
    schedule: cc.reduce((e, t) => {
      let r = o[t];
      return ((e[t] = (e, t = !1, i = !1) => (n || g(), r.schedule(e, t, i))), e);
    }, {}),
    cancel: (e) => {
      for (let t = 0; t < cc.length; t++) o[cc[t]].cancel(e);
    },
    state: i,
    steps: o,
  };
...
function Ge(e) {
  return (
    isNaN(e) && typeof e == `string` && (e.match(Sc)?.length || 0) + (e.match(Ic)?.length || 0) > 0
  );
}
function Ke(e) {
  let t = e.toString(),
...
function Je({ split: e, types: t }) {
  ...
  return (r) => {
    ...
    for (let a = 0; a < n; a++)
      if (((i += e[a]), r[a] !== void 0)) {
        let e = t[a];
        e === Lc ? (i += xc(r[a])) : e === Rc ? (i += K.transform(r[a])) : (i += r[a]);
      }
    return i;
  };
}
...
function Xe(e) {
  let t = Ke(e);
  return Je(t)(t.values.map((e, n) => Wc(e, t.split[n])));
}
function Ze(e, t, n) {
  return (
    n < 0 && (n += 1),
...
function ct(e) {
  let t = 0,
    n = e.next(t);
  for (; !n.done && t < Qc; ) ((t += 50), (n = e.next(t)));
  return t >= Qc ? 1 / 0 : t;
}
...
function ft({
  ...
  let i, a;
  Ps(e <= L(Y.maxDuration), `Spring duration must be 10 seconds or less`, `spring-duration-limit`);
  let o = 1 - t;
  ((o = N(Y.minDamping, Y.maxDamping, o)),
    (e = N(Y.minDuration, Y.maxDuration, R(e))),
    o < 1
      ? ((i = (t) => {
          let r = t * o,
            i = r * e,
...
function ht(e = Y.visualDuration, t = Y.bounce) {
...
function vt(e, t, n) {
  ...
  for (let n = 0; n < a; n++) {
    let a = i(e[n], e[n + 1]);
    (t && (a = Rs(Array.isArray(t) ? t[n] || I : t, a)), r.push(a));
  }
  return r;
}
function yt(e, t, { clamp: n = !0, ease: r, mixer: i } = {}) {
  let a = e.length;
  if (
    (P(a === t.length, `Both input and output ranges must be the same length`, `range-length`),
    a === 1)
  )
    return () => t[0];
...
function zt(
  ...
  c && (u.offset = c);
  let d = Rt(s, i);
  (Array.isArray(d) && (u.easing = d), z.value && fc.waapi++);
  let f = {
    delay: r,
    duration: i,
...
function Vt({ type: e, ...t }) {
  return Bt(e) && Pl() ? e.applyToOptions(t) : ((t.duration ??= 300), (t.ease ??= `easeOut`), t);
}
function Ht(e) {
  return e in Rl;
}
function Ut(e) {
  typeof e.ease == `string` && Ht(e.ease) && (e.ease = Rl[e.ease]);
}
function Wt(e) {
...
function Qt(e, t, n = 1) {
  ...
  if (a) {
    let e = a.trim();
    return Fs(e) ? parseFloat(e) : e;
  }
  return gc(i) ? Qt(i, t, n + 1) : i;
}
function $t(e, t) {
  if (e?.inherit && t) {
    let { inherit: n, ...r } = e;
...
function cn(e, t) {
  ...
  for (let t in ((i = { ...i, ...n }), i)) on(e, t, sn(i[t]));
}
function ln(e) {
  return !!(X(e) && e.add);
}
...
function mn(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  for (let t in s) {
    let r = e.getValue(t, e.latestValues[t] ?? null),
      i = s[t];
    if (i === void 0 || (d && pn(d, t))) continue;
    let o = { delay: n, ...en(a || {}, t) },
      c = r.get();
    ...
    if (f.MotionHandoffAnimation) {
      let n = fn(e);
      if (n) {
        let e = f.MotionHandoffAnimation(n, t, B);
        e !== null && ((o.startTime = e), (p = !0));
      }
    }
    un(e, t);
    let m = l ?? e.shouldReduceMotion;
    r.start(iu(t, r, i, m && au.has(t) ? { type: !1 } : o, e, p));
    let h = r.animation;
    h && u.push(h);
  }
  if (o) {
...
function yn(e, t) {
  let n = wu(e);
  return (Tu.has(n) || (n = q), n.getAnimatableNone ? n.getAnimatableNone(t) : void 0);
}
function bn(e) {
  return typeof e == `number` ? e === 0 : e === null ? !0 : e === `none` || e === `0` || Is(e);
}
function xn(e, t, n) {
  let r = 0,
    i;
...
function Pn(e, t, n = {}) {
  let [r, i, a] = En(e, n),
    o = (e) => {
      ...
      if (!Nn(e) || Lu.has(e)) return;
      (Fu.add(r), n.stopPropagation && Lu.add(e));
      let a = t(r, e),
        o = (e, t) => {
          (f.removeEventListener(`pointerup`, s),
            f.removeEventListener(`pointercancel`, c),
            Fu.has(r) && Fu.delete(r),
            Nn(e) && typeof a == `function` && a(e, { success: t }));
        },
        s = (e) => {
          o(e, r === f || r === document || n.useGlobalTarget || ju(r, e.target));
        },
        c = (e) => {
          o(e, !1);
        };
      (f.addEventListener(`pointerup`, s, i), f.addEventListener(`pointercancel`, c, i));
    };
  return (
    r.forEach((e) => {
...
function Rn() {
  typeof ResizeObserver > `u` || (zu = new ResizeObserver(Ln));
}
function zn(e, t) {
  zu || Rn();
  let n = Sn(e);
  ...
  return (
    ...
    () => {
      (Uu.delete(e),
        !Uu.size &&
          typeof Wu == `function` &&
          (f.removeEventListener(`resize`, Wu), (Wu = void 0)));
    }
  );
}
function Hn(e, t) {
...
function Jn(e, t, n = {}) {
  ...
  if (
    (e.attach((e, t) => {
      ((a = e), (o = (e) => t(Yn(e, s))), B.postRender(u));
    }, c),
    X(t))
  ) {
...
function tr(e) {
  return $n(e.animate) || Qu.some((t) => er(e[t]));
}
function nr(e) {
...
function yr(e, t, n, r = !1) {
  ...
  (t.x < cd && t.x > sd && (t.x = 1), t.y < cd && t.y > sd && (t.y = 1));
}
function O(e, t) {
  ((e.min += t), (e.max += t));
}
function br(e, t, n, r, i = 0.5) {
  _r(e, t, n, J(e.min, e.max, i), r);
}
function xr(e, t) {
...
function kr(e) {
  for (let t in e) ((pd[t] = e[t]), mc(t) && (pd[t].isCSSVariable = !0));
}
function Ar(e, { layout: t, layoutId: n }) {
  return (
    bl.has(e) || e.startsWith(`origin`) || ((t || n !== void 0) && (!!pd[e] || e === `opacity`))
  );
}
function jr(e, t, n) {
  let r = e.style,
...
function Fr(
  ...
  for (let e of vd) d[e] !== void 0 && ((f[e] = d[e]), delete d[e]);
  (t !== void 0 && (d.x = t),
    n !== void 0 && (d.y = n),
    r !== void 0 && (d.scale = r),
...
function Ir(e, t, n, r) {
  for (let n in (Dr(e, t, void 0, r), t.attrs)) e.setAttribute(yd.has(n) ? n : dn(n), t.attrs[n]);
}
function Lr(e, t, n) {
  let r = jr(e, t, n);
  for (let n in e)
...
function Jr(e, t, n, r = 0.5) {
  ((e.origin = r),
    ...
    ((e.scale >= Ed && e.scale <= Dd) || isNaN(e.scale)) && (e.scale = 1),
    ((e.translate >= kd && e.translate <= Ad) || isNaN(e.translate)) && (e.translate = 0));
}
function Yr(e, t, n, r) {
...
function ri(e, t, n, r) {
  (ni(e.x, t, jd, n ? n.x : void 0, r ? r.x : void 0),
    ni(e.y, t, Md, n ? n.y : void 0, r ? r.y : void 0));
}
function ii(e) {
...
function xi(e) {
  ...
  if (f.MotionHasOptimisedAnimation(n, `transform`)) {
    ...
    f.MotionCancelOptimisedAnimation(n, `transform`, B, !(t || r));
  }
  let { parent: r } = e;
...
function Si({
  ...
  return class {
    constructor(e = {}, n = t?.()) {
      ((this.id = Kd++),
        ...
        (this.updateProjection = () => {
          ((this.projectionUpdateScheduled = !1),
            z.value && (Ud.nodes = Ud.calculatedTargetDeltas = Ud.calculatedProjections = 0),
            this.nodes.forEach(Ti),
            this.nodes.forEach(Pi),
            this.nodes.forEach(Fi),
            this.nodes.forEach(Ei),
            z.addProjectionMetrics && z.addProjectionMetrics(Ud));
        }),
    ...
    addEventListener(e, t) {
      return (
        this.eventHandlers.has(e) || this.eventHandlers.set(e, new Bs()),
          ...
          e(t, () => {
            ...
            e !== r &&
              ...
              Hd.hasAnimatedSinceResize &&
                ((Hd.hasAnimatedSinceResize = !1), this.nodes.forEach(Ni)));
          }));
      }
          ...
          this.addEventListener(
            ...
            ({ delta: e, hasLayoutChanged: t, hasRelativeLayoutChanged: n, layout: r }) => {
              ...
              if (
                ...
                let t = { ...en(a, `layout`), onPlay: o, onComplete: s };
    ...
    willUpdate(e = !0) {
      ...
      if (
        (f.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && xi(this),
    ...
    update() {
      ...
      ((this.animationCommitId = this.animationId),
        ...
        this.clearAllSnapshots());
      let e = U.now();
      ((H.delta = N(0, 1e3 / 60, e - H.timestamp)),
        (H.timestamp = e),
        (H.isProcessing = !0),
        uc.update.process(H),
        uc.preRender.process(H),
        uc.render.process(H),
        (H.isProcessing = !1));
    }
    didUpdate() {
    ...
    removeTransform(e) {
      ...
      for (let e = 0; e < this.path.length; e++) {
        ...
        let r;
        (n.instance &&
          (dr(n.latestValues) && n.updateSnapshot(), (r = Q()), k(r, n.measurePageBox())),
    ...
    resolveTargetDelta(e = !1) {
      ...
      (a &&
        ...
        !(!this.relativeTarget && !this.targetDelta) &&
          ...
          z.value && Ud.calculatedTargetDeltas++));
    }
    ...
    calcProjection() {
      ...
      (!this.projectionDelta || !this.prevProjectionDelta
        ...
        z.value && Ud.calculatedProjections++);
    }
    hide() {
      this.isVisible = !1;
    }
    ...
    createProjectionDeltas() {
      ((this.prevProjectionDelta = Ju()),
        (this.projectionDelta = Ju()),
        (this.projectionDeltaWithTransform = Ju()));
    }
    setAnimationOrigin(e, t = !1) {
      ...
      let o = Q(),
        ...
        u = !!(s && !l && this.options.crossfade === !0 && !this.path.some(Vi));
      this.animationProgress = 0;
      let d;
      ((this.mixTargetDelta = (t) => {
        ...
        (Ri(a.x, e.x, n),
          ...
          this.relativeTarget &&
            ...
            Bi(this.relativeTarget, this.relativeTargetOrigin, o, n),
            d && si(this.relativeTarget, d) && (this.isProjectionDirty = !1),
            (d ||= Q()),
            k(d, this.relativeTarget)),
          s && ((this.animationValues = i), pi(i, r, this.latestValues, n, u, l)),
    ...
    startAnimation(e) {
      (this.notifyListeners(`animationStart`),
        ...
        (this.pendingAnimation &&= (V(this.pendingAnimation), void 0)),
        (this.pendingAnimation = B.update(() => {
          ((Hd.hasAnimatedSinceResize = !0),
            ...
            (this.currentAnimation = gi(this.motionValue, [0, 1e3], {
              ...
              onComplete: () => {
                (fc.layout--, e.onComplete && e.onComplete(), this.completeAnimation());
              },
            })),
    ...
    applyTransformsToTarget() {
      ...
      if (!(!t || !n || !r)) {
        ...
        (k(t, n), Sr(t, i), Yr(this.projectionDeltaWithTransform, this.layoutCorrected, t, i));
      }
    }
    ...
    resetSkewAndRotation() {
      ...
      for (let t = 0; t < Wd.length; t++)
        (bi(`rotate${Wd[t]}`, e, r, this.animationValues),
          bi(`skew${Wd[t]}`, e, r, this.animationValues));
    ...
    applyProjectionStyles(e, t) {
      ...
      pd)) {
        ...
        let { correct: n, applyTo: o, isCSSVariable: s } = pd[t],
...
function Xi({ children: e, isPresent: t, anchorX: n, anchorY: a, root: o, pop: s }) {
  let c = T(),
    l = i(null),
    d = i({ width: 0, height: 0, top: 0, left: 0, right: 0, bottom: 0 }),
    { nonce: f } = b($),
    p = Yi(l, e.props?.ref ?? e?.ref);
  return (
    r(() => {
      let { width: e, height: r, top: i, left: u, right: p, bottom: m } = d.current;
      if (t || s === !1 || !l.current || !e || !r) return;
      let h = n === `left` ? `left: ${u}` : `right: ${p}`,
        g = a === `bottom` ? `bottom: ${m}` : `top: ${i}`;
...
function oa(e) {
  typeof e == `function` && (pf = (t) => (t.startsWith(`on`) ? !aa(t) : e(t)));
}
function sa(e, t, n) {
  let r = {};
  for (let i in e)
...
function fa(e) {
  let { initial: t, animate: r } = da(e, b(mf));
  return n(() => ({ initial: t, animate: r }), [pa(t), pa(r)]);
}
function pa(e) {
...
function va(e, t, r, i) {
  let a = n(() => {
    let n = vf();
    return (Fr(n, t, bd(i), e.transformTemplate, e.style), { ...n.attrs, style: { ...n.style } });
  }, [t]);
  if (e.style) {
    let t = {};
    (ma(t, e.style, e), (a.style = { ...t, ...a.style }));
  }
  return a;
}
function ya(e) {
...
function ba(e, t, r, { latestValues: i }, a, o = !1, s) {
  let c = ((s ?? ya(e)) ? va : _a)(t, i, a, e),
    u = sa(t, typeof e == `string`, o),
    d = e === l ? {} : { ...u, ...c, ref: r },
    { children: f } = t,
    p = n(() => (X(f) ? f.get() : f), [f]);
  return w(e, { ...d, children: p });
}
function xa(e, t, n) {
  let a = i(n);
  r(() => {
  ...
  return y(
    (n) => {
      ...
      if (typeof r == `function`)
        ...
        } else o.current ? (o.current(), (o.current = null)) : r(n);
      else r && (r.current = n);
...
function Ca(e, t, n, a, o, s) {
  ...
  let v = g.current,
    y = b(gf);
  v && !v.projection && o && (v.type === `html` || v.type === `svg`) && wa(g.current, n, o, y);
  let x = i(!1);
  r(() => {
...
function Ea(e, { forwardMotionProps: t = !1, type: n } = {}, r, i) {
  r && ia(r);
  let a = n ? n === `svg` : ya(e),
    o = a ? xf : bf;
  function s(n, s) {
    ...
    if (!u && f !== void 0) {
      Oa(l, r);
      let t = ka(l);
      ((c = t.MeasureLayout), (d.visualElement = Ca(e, p, l, i, t.ProjectionNode, a)));
    }
    return x(mf.Provider, {
      value: d,
      children: [
        c && d.visualElement ? g(c, { visualElement: d.visualElement, ...l }) : null,
        ba(e, n, xa(p, d.visualElement, s), p, u, t, a),
      ],
    });
  }
...
function Ga(e, t) {
  let n = 0.5,
    ...
    i = A(t);
  return (
    i > r ? (n = zs(t.min, t.max - r, e.min)) : r > i && (n = zs(e.min, e.max - i, t.min)),
    N(0, 1, n)
  );
}
function Ka(e, t) {
...
function eo(e) {
  let [t, n] = Qi(),
    r = b(As);
  return g(Bf, { ...e, layoutGroup: r, switchLayoutGroup: b(gf), isPresent: t, safeToRemove: n });
}
function to(e, t, n) {
  let { props: r } = e;
  e.animationState && r.whileHover && e.animationState.setActive(`whileHover`, n === `Start`);
  let i = r[`onHover` + n];
  i && B.postRender(() => i(t, ja(t)));
}
function no(e, t, n) {
  let { props: r } = e;
...
function oo(e, t, n, r) {
  ...
  ((i.current = Math.abs(e[`scroll${o}`])),
    ...
    (i.progress = zs(0, i.scrollLength, i.current)));
  let l = r - c;
  i.velocity = l > tp ? 0 : Fe(i.current - s, l);
}
function so(e, t, n) {
...
function go(e, { container: t = document.scrollingElement, trackContentSize: n = !1, ...r } = {}) {
  ...
  if ((i.add(a), !lp.has(t))) {
    let e = () => {
        for (let e of i) e.measure(H.timestamp);
        B.preUpdate(n);
      },
      n = () => {
    ...
    (f.addEventListener(`resize`, r),
      t !== document.documentElement && up.set(t, Hn(t, r)),
  ...
  return (
    ...
    () => {
      ...
      let r = pp.get(t);
      (r && (V(r), pp.delete(t)), fp.delete(t));
    }
  );
}
function _o(e) {
  return f === void 0 ? !1 : e ? Nl() : Ml();
}
function vo(e) {
...
function Do(e, { axis: t = `y`, container: n = document.scrollingElement, ...r } = {}) {
  ...
  return typeof e == `function` ? Eo(e, i) : wo(e, i);
}
function Oo(e, t, n, r) {
  return {
    factory: (i) =>
      Do(i, { ...t, axis: e, container: n?.current || void 0, target: r?.current || void 0 }),
    times: [0, 1],
    keyframes: [0, 1],
    ease: (e) => e,
    duration: 1,
...
function ko(e, t) {
  return f === void 0 ? !1 : e ? Nl() && !!xo(t) : Ml();
}
function Ao({ container: e, target: t, ...n } = {}) {
  ...
  return (
    ...
    c(() => {
      if (o.current)
        return (
          P(!yp(e), `Container ref is defined but not hydrated`, `use-scroll-ref`),
          P(!yp(t), `Target ref is defined but not hydrated`, `use-scroll-ref`),
          s()
        );
    }, [s]),
    r
...
function No(e) {
  ((cu.current = []), e());
  let t = Mo(cu.current, e);
  return ((cu.current = void 0), t);
}
function Po(e, t, n, r) {
...
function Lo(e, t = {}) {
  ...
  if (n) return Po(i);
  let a = jo(i());
  return (r(() => Jn(a, e, t), [a, JSON.stringify(t)]), a);
}
function Ro(e, t = {}) {
  ...
  let e = !1,
    ...
    n = {
      ...
      start(n, r) {
        ...
        return (
          t.forEach((e) => {
            i.push(_n(e, n, { transitionOverride: r }));
          }),
          Promise.all(i)
        );
      },
...
function Xo(e, t, n, r, i, a) {
  Yo(e, i, a);
  for (let o = 0; o < t.length; o++) e.push({ value: t[o], at: J(i, a, r[o]), easing: Re(n, o) });
}
function Zo(e, t) {
  ...
  for (let n = 0; n < e.length; n++) {
    ...
    let g = 0,
      _ = (e, n, r, o = 0, s = 0) => {
        ...
        if ((ee > 0 && bt(u, ee), c.length === 1 && c.unshift(null), m)) {
          (P(m < Sp, `Repeat count too high, must be less than 20`, `repeat-count-high`),
            (b = qo(b, m)));
          let e = [...c],
            t = [...u];
          ...
          for (let r = 0; r < m; r++) {
            ...
            for (let i = 0; i < e.length; i++)
              (u.push(t[i] + (r + 1)), y.push(i === 0 ? `linear` : Re(n, i - 1)));
          }
          Zo(u, m);
        }
        let T = w + b;
    ...
    s.forEach((e, r) => {
      for (let i in e) {
        ...
        for (let e = 0; e < a.length; e++) {
          ...
          (s.push(n), c.push(zs(0, f, t)), l.push(r || `easeOut`));
        }
...
function is(e) {
  let t = {
    ...
    n = Fn(e) && !Wn(e) ? new xd(t) : new md(t);
  (n.mount(e), Xu.set(e, n));
}
function as(e) {
  let t = new hd({
    presenceContext: null,
...
function ss(e, t, n, r) {
  let i = [];
  if (os(e, t)) i.push(gi(e, (Go(t) && t.default) || t, n && (n.default || n)));
  else {
    if (e == null) return i;
    let a = Ko(e, t, r),
      o = a.length;
  ...
  function r(e, r, i) {
    ...
    if (ls(e)) {
      ...
      (typeof i == `function` && (o = i),
        (a = cs(e, n === void 0 ? s : { reduceMotion: n, ...s }, t)));
    } else {
      let { onComplete: s, ...c } = i || {};
      (typeof s == `function` && (o = s),
        (a = ss(e, r, n === void 0 ? c : { reduceMotion: n, ...c }, t)));
    }
    let s = new Yl(a);
    return (
      o && s.finished.then(o),
...
function vs(e, { root: t, margin: n, amount: r, once: i = !1, initial: a = !1 } = {}) {
  let [o, s] = d(a);
  return (
    c(() => {
...
function xs({ children: e, as: t = `ul`, axis: n = `y`, onReorder: r, values: a, ...o }, s) {
  let l = M(() => $f[t]),
    u = [],
    d = i(!1),
    f = i(null);
  P(!!a, `Reorder.Group must be provided a values prop`, `reorder-values`);
  let p = {
    axis: n,
    groupRef: f,
    registerItem: (e, t) => {
      let r = u.findIndex((t) => e === t.value);
      (r === -1 ? u.push({ value: e, layout: t[n] }) : (u[r].layout = t[n]), u.sort(Ss));
    },
    updateOrder: (e, t, n) => {
      if (d.current) return;
      let i = bs(u, e, t, n);
  ...
  return g(l, {
    ...
    ref: m,
    ignoreStrict: !0,
    children: g(Ap.Provider, { value: p, children: e }),
  });
}
function Ss(e, t) {
...
function Ds(e, t, n, r) {
  ...
  let i = Ts(e, n);
  if (!i) return;
  let { amount: a, edge: o } = Es(t - (n === `x` ? f.scrollX : f.scrollY), i, n);
  if (o === null) {
...
function ks(
  ...
  P(!!u, `Reorder.Item must be a child of Reorder.Group`, `reorder-item-child`);
  let { axis: p, registerItem: m, updateOrder: h, groupRef: _ } = u;
  return g(l, {
    drag: p,
    ...s,
    dragSnapToOrigin: !0,
    ...
    onDrag: (e, t) => {
      ...
      (h(n, d[p].get(), r[p]), Ds(_.current, a[p], p, r[p]), i && i(e, t));
    },
    onDragEnd: (e, t) => {
      (Cs(), a && a(e, t));
    },
...
var As,
  ...
  zp = t(() => {
    (o(),
      ...
      (Hs = (e, t, n) => (((1 - 3 * n + 3 * t) * e + (3 * n - 6 * t)) * e + 3 * t) * e),
      (Us = 1e-7),
      (Ws = 12),
      (Gs = (e) => (t) => (t <= 0.5 ? e(2 * t) / 2 : (2 - e(2 * (1 - t))) / 2)),
      (Ks = (e) => (t) => 1 - e(1 - t)),
      (qs = Le(0.33, 1.53, 0.69, 0.99)),
      (Js = Ks(qs)),
      (Ys = Gs(Js)),
      (Xs = (e) => (e >= 1 ? 1 : (e *= 2) < 1 ? 0.5 * Js(e) : 0.5 * (2 - 2 ** (-10 * (e - 1))))),
      (Zs = (e) => 1 - Math.sin(Math.acos(e))),
      (Qs = Ks(Zs)),
      ($s = Gs(Zs)),
      (ec = Le(0.42, 0, 1, 1)),
      (tc = Le(0, 0, 0.58, 1)),
      ...
      (sc = (e) => {
        if (ic(e)) {
          ...
          return (P(ac[e] !== void 0, `Invalid easing type '${e}'`, `invalid-easing-type`), ac[e]);
        return e;
      }),
      ...
      ({
        ...
        state: H,
        steps: uc,
      } = Be(typeof requestAnimationFrame < `u` ? requestAnimationFrame : I, !0)),
      (U = {
        now: () => (
          dc === void 0 &&
            U.set(H.isProcessing || F.useManualTiming ? H.timestamp : performance.now()),
          dc
        ),
        set: (e) => {
          ((dc = e), queueMicrotask(Ve));
        },
      }),
      (fc = { layout: 0, mainThread: 0, waapi: 0 }),
      (pc = (e) => (t) => typeof t == `string` && t.startsWith(e)),
      (mc = pc(`--`)),
      (hc = pc(`var(--`)),
      (gc = (e) => (hc(e) ? _c.test(e.split(`/*`)[0].trim()) : !1)),
      (_c = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu),
      (vc = { test: (e) => typeof e == `number`, parse: parseFloat, transform: (e) => e }),
      (yc = { ...vc, transform: (e) => N(0, 1, e) }),
      (bc = { ...vc, default: 1 }),
      (xc = (e) => Math.round(e * 1e5) / 1e5),
      (Sc = /-?(?:\d+(?:\.\d+)?|\.\d+)/gu),
      (Cc =
      ...
      (Ec = (e) => N(0, 255, e)),
      (Dc = { ...vc, transform: (e) => Math.round(Ec(e)) }),
      (Oc = {
        test: wc(`rgb`, `red`),
      ...
      (kc = { test: wc(`#`), parse: We, transform: Oc.transform }),
      (Ac = (e) => ({
      ...
      (K = {
        test: (e) => Oc.test(e) || kc.test(e) || Fc.test(e),
        parse: (e) => (Oc.test(e) ? Oc.parse(e) : Fc.test(e) ? Fc.parse(e) : kc.parse(e)),
        transform: (e) =>
          typeof e == `string` ? e : e.hasOwnProperty(`red`) ? Oc.transform(e) : Fc.transform(e),
        getAnimatableNone: (e) => {
          let t = K.parse(e);
      ...
      (q = { test: Ge, parse: qe, createTransformer: Ye, getAnimatableNone: Xe }),
      (J = (e, t, n) => e + (t - e) * n),
      (Gc = (e, t, n) => {
        let r = e * e,
          i = n * (t * t - r) + r;
      ...
      (al = (e) => {
        ...
        return {
          ...
          stop: () => V(t),
          now: () => (H.isProcessing ? H.timestamp : U.now()),
        };
      }),
      (ol = { decay: _t, inertia: _t, tween: wt, keyframes: wt, spring: ht }),
      (sl = class {
        constructor() {
          this.updateFinished();
        }
      ...
      (ll = class extends sl {
        constructor(e) {
          (super(),
            ...
            (this.stop = () => {
              ...
              (e && e.updatedAt !== U.now() && this.tick(U.now()),
                (this.isStopped = !0),
        ...
        initAnimation() {
          ...
          s !== wt &&
            typeof o[0] != `number` &&
            ((this.mixKeyframes = Rs(cl, st(o[0], o[1]))), (o = [0, 100]));
        ...
        set speed(e) {
          ...
          (t && this.driver && this.updateTime(U.now()),
      ...
      (kl = class {
        ...
        scheduleResolve() {
          ((this.state = `scheduled`),
            this.isAsync
              ? (Tl.add(this), El || ((El = !0), B.read(Pt), B.resolveKeyframes(Nt)))
      ...
      (Al = (e) => e.startsWith(`--`)),
      (jl = {}),
      (Ml = Lt(() => f.ScrollTimeline !== void 0, `scrollTimeline`)),
      (Nl = Lt(() => f.ViewTimeline !== void 0, `viewTimeline`)),
      (Pl = Lt(() => {
        try {
      ...
      (Rl = { anticipate: Xs, backInOut: Ys, circInOut: $s }),
      (zl = 10),
      (Bl = class extends Ll {
        constructor(e) {
          (Ut(e),
        ...
        updateMotionValue(e) {
          ...
          let o = new ll({ ...a, autoplay: !1 }),
            s = Math.max(zl, U.now() - this.startTime),
            c = N(0, zl, s - zl),
            l = o.sample(s).value,
            { name: u } = this.options;
          (i && u && It(i, u, l),
      ...
      (ql = class extends sl {
        constructor({
          ...
          ((this.keyframeResolver = new (l?.KeyframeResolver || kl)(
            o,
        ...
        onKeyframesResolved(e, t, n, r) {
          ...
          Jt(e, i, a, o) ||
            ((u = !1),
            (F.instantAnimations || !s) && l?.(Tt(e, n, t)),
            (e[0] = e[e.length - 1]),
            Wt(n),
            (n.repeat = 0));
          let d = {
      ...
      (Xl = /^var\(--(?:([\w-]+)|([\w-]+), ?([a-zA-Z\d ()%#.,-]+))\)/u),
      (Zl = 4),
      (Ql = { type: `spring`, stiffness: 500, damping: 25, restSpeed: 10 }),
      ($l = (e) => ({
        type: `spring`,
        stiffness: 550,
      ...
      (nu = (e, { keyframes: t }) =>
        t.length > 2 ? eu : bl.has(e) ? (e.startsWith(`scale`) ? $l(t[1]) : Ql) : tu),
      (ru = new Set([
        `when`,
        `delay`,
        `delayChildren`,
        ...
        (o) => {
          ...
          if (
            ((u.type === !1 || (u.duration === 0 && !u.repeatDelay)) &&
              (Wt(u), u.delay === 0 && (d = !0)),
            (F.instantAnimations || F.skipAnimations || i?.shouldSkipAnimations) &&
              ((d = !0), Wt(u), (u.delay = 0)),
      ...
      (au = new Set([`width`, `height`, `top`, `left`, `right`, `bottom`, ...yl])),
      (ou = 30),
      (su = (e) => !isNaN(parseFloat(e))),
      (cu = { current: void 0 }),
      (lu = class {
        constructor(e, t = {}) {
        ...
        setCurrent(e) {
          ((this.current = e),
            ...
            this.canTrackVelocity === null &&
              e !== void 0 &&
              (this.canTrackVelocity = su(this.current)));
        }
        ...
        on(e, t) {
          this.events[e] || (this.events[e] = new Bs());
        ...
        get() {
          return (cu.current && cu.current.push(this), this.current);
        }
        getPrevious() {
          return this.prev;
        }
        getVelocity() {
          let e = U.now();
          if (!this.canTrackVelocity || this.prevFrameValue === void 0 || e - this.updatedAt > ou)
            return 0;
          let t = Math.min(this.updatedAt - this.prevUpdatedAt, ou);
      ...
      (fu = `data-` + dn(du)),
      (pu = (e) => (t) => t.test(e)),
      (mu = [vc, G, W, jc, Nc, Mc, { test: (e) => e === `auto`, parse: (e) => e }]),
      (hu = (e) => mu.find(pu(e))),
      (gu = {
        rotate: jc,
        rotateX: jc,
      ...
      (Du = class extends kl {
        ...
        readKeyframes() {
          ...
          for (let n = 0; n < e.length; n++) {
            let r = e[n];
            if (typeof r == `string` && ((r = r.trim()), gc(r))) {
              let i = Qt(r, t.current);
              (i !== void 0 && (e[n] = i), n === e.length - 1 && (this.finalKeyframe = r));
            }
          }
          if ((this.resolveNoneKeyframes(), !au.has(n) || e.length !== 2)) return;
          let [r, i] = e,
            a = hu(r),
            o = hu(i);
          if (He(r) !== He(i) && wl[n]) {
        ...
        measureInitialState() {
          ...
          (n === `height` && (this.suspendedScrollY = f.pageYOffset),
            (this.measuredOrigin = wl[n](e.measureViewportBox(), f.getComputedStyle(e.current))),
        ...
        measureEndState() {
          ...
          let i = n.length - 1,
            a = n[i];
          ((n[i] = wl[t](e.measureViewportBox(), f.getComputedStyle(e.current))),
      ...
      ({ schedule: ku, cancel: Au } = Be(queueMicrotask, !1)),
      (Z = { x: !1, y: !1 }),
      (ju = (e, t) => (t ? (e === t ? !0 : ju(e, t.parentElement)) : !1)),
      (Mu = (e) =>
        e.pointerType === `mouse`
      ...
      (Gu = [...mu, K, q]),
      (Ku = (e) => Gu.find(pu(e))),
      (qu = () => ({ translate: 0, scale: 1, origin: 0, originPoint: 0 })),
      (Ju = () => ({ x: qu(), y: qu() })),
      (Yu = () => ({ min: 0, max: 0 })),
      (Q = () => ({ x: Yu(), y: Yu() })),
      (Xu = new WeakMap()),
      ...
      (id = class {
          ...
          ((this.current = e),
            ...
            this.reducedMotionConfig === `never`
              ...
              : this.reducedMotionConfig === `always`
                ...
                : (ed.current || ir(), (this.shouldReduceMotion = $u.current)),
        ...
        readValue(e, t) {
          ...
          return (
            n != null &&
              (typeof n == `string` && (Fs(n) || Is(n))
                ? (n = parseFloat(n))
                : !Ku(n) && q.test(t) && (n = yn(e, t)),
        ...
        on(e, t) {
          return (this.events[e] || (this.events[e] = new Bs()), this.events[e].add(t));
        }
        notify(e, ...t) {
      ...
      (pd = {
        ...
        borderTopLeftRadius: dd,
        borderTopRightRadius: dd,
        borderBottomLeftRadius: dd,
        borderBottomRightRadius: dd,
        boxShadow: fd,
      }),
      (md = class extends ad {
        constructor() {
        ...
        readValueFromInstance(e, t) {
          if (bl.has(t)) return this.projection?.isProjecting ? kt(t) : vl(e, t);
          {
            let n = Mr(e),
              r = (mc(t) ? n.getPropertyValue(t) : n[t]) || 0;
      ...
      (gd = { offset: `stroke-dashoffset`, array: `stroke-dasharray` }),
      (_d = { offset: `strokeDashoffset`, array: `strokeDasharray` }),
      (vd = [`offsetDistance`, `offsetPath`, `offsetRotate`, `offsetAnchor`]),
      (yd = new Set([
        `baseFrequency`,
        `diffuseConstant`,
        `kernelMatrix`,
      ...
      (xd = class extends ad {
        ...
        readValueFromInstance(e, t) {
          ...
          return ((t = yd.has(t) ? t : dn(t)), e.getAttribute(t));
        }
        scrapeMotionValuesFromProps(e, t, n) {
          return Lr(e, t, n);
        }
      ...
      (Jd = (e) => s !== void 0 && s.userAgent && s.userAgent.toLowerCase().includes(e)),
      ...
      ($d = Si({
        ...
        defaultParent: () => {
          if (!Qd.current) {
            let e = new Xd({});
            (e.mount(f), e.setOptions({ layoutScroll: !0 }), (Qd.current = e));
          }
          return Qd.current;
        },
        resetTransform: (e, t) => {
      ...
      (tf = ({
        ...
        return (
          ...
          g(Ns.Provider, { value: h, children: e })
        );
      }),
      (nf = (e) => e.key || ``),
      (rf = ({
        ...
        let [p, m] = Qi(c),
          ...
          [T, te] = d(h);
        Ms(() => {
          ((v.current = !1), (y.current = h));
          for (let e = 0; e < T.length; e++) {
            let t = nf(T[e]);
            _.includes(t) ? (x.delete(t), S.current.delete(t)) : x.get(t) !== !0 && x.set(t, !1);
          }
        }, [T, _.length, _.join(`-`)]);
        let E = [];
        if (h !== w) {
          ...
          return (s === `wait` && E.length && (e = E), te($i(e)), ee(h), null);
        }
        let { forceRender: ne } = b(As);
        return g(C, {
          children: T.map((e) => {
            let n = nf(e),
              i = c && !p ? !1 : h === T || _.includes(n);
            return g(
              tf,
              {
                isPresent: i,
      ...
      (cf = ({ children: e, id: t, inherit: r = !0 }) => {
        ...
        l.current === null &&
          (sf(r) && u && (t = t ? u + `-` + t : u),
          (l.current = { id: t, group: (of(r) && a.group) || Ki() }));
        let d = n(() => ({ ...l.current, forceRender: s }), [c]);
        return g(As.Provider, { value: d, children: e });
      }),
      (lf = a({ strict: !1 })),
      (uf = {
        animation: [
      ...
      (pf = (e) => !aa(e)));
    try {
      oa(ue(`@emotion/is-prop-valid`).default);
    } catch {}
    ((mf = a({})),
      (hf = (e) => (t, n) => {
        let r = b(mf),
      ...
      (bf = hf({ scrapeMotionValuesFromProps: jr, createRenderState: _f })),
      (xf = hf({ scrapeMotionValuesFromProps: Lr, createRenderState: vf })),
      ...
      (Df = (e) => (t) => Mu(t) && e(t, ja(t))),
      (Of = (e, t) => Math.abs(e - t)),
      (kf = (e, t) => ((t.isSVG ?? ya(e)) ? new xd(t) : new md(t, { allowProjection: e !== l }))),
      ...
      (Ff = class {
        ...
        startAxisValueAnimation(e, t) {
          ...
          return (un(this.visualElement, e), n.start(iu(e, n, 0, t, this.visualElement, !1)));
        }
        stopAnimation() {
        ...
        addListeners() {
          ...
          let o = _i(f, `resize`, () => this.scalePositionWithinConstraints()),
      ...
      (Vf = { pan: { Feature: Rf }, drag: { Feature: If, ProjectionNode: $d, MeasureLayout: eo } }),
      (Hf = class extends od {
        mount() {
      ...
      (Xf = class extends od {
        ...
        startObserver() {
          ...
          this.stopObserver = io(this.node.current, a, (e) => {
      ...
      (Qf = { layout: { ProjectionNode: $d, MeasureLayout: eo } }),
      ($f = Aa({ ...Ef, ...Zf, ...Vf, ...Qf }, kf)),
      ...
      (fp = new WeakMap()),
      (pp = new WeakMap()),
      (mp = (e) => (e === document.scrollingElement ? f : e)),
      (hp = [
        [sp.Enter, `entry`],
        [sp.Exit, `exit`],
        [sp.Any, `cover`],
...
//# sourceMappingURL=motion.BEaCLYSy.mjs.map
