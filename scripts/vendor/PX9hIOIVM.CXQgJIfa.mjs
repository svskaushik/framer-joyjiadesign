...
import { S as p, a as m, r as ne, t as re } from "./motion.BEaCLYSy.mjs";
import {
  A as h,
  Dt as g,
  Et as _,
...
function ue() {
  ...
  let t = null,
    n = !1;
  if (a.location.ancestorOrigins && a.location.ancestorOrigins.length > 0) {
    let e = a.location.ancestorOrigins[0];
    try {
      t = new URL(e).host;
    } catch {}
    ...
    return r && !i
      ...
      : s(e, {
          ...
          onClick: (e) => {
            (e.preventDefault(),
              a.open(
                `https://www.framer.com/r/badge/?utm_campaign=freeplanbadge&utm_source=${encodeURIComponent(a?.location?.origin)}`
              ));
          },
...
e(() => {
  (u(),
    ...
    (K = y(G)),
    (q = y(I)),
    (J = g(I, { nodeId: `pBR1Ew0r8`, override: fe, scopeId: `PX9hIOIVM` })),
    (Y = x(ie(g(p.a, { nodeId: `HK2sXlagE`, override: de, scopeId: `PX9hIOIVM` })))),
    (X = `framer-6jWyo`),
    (Z = { HK2sXlagE: `framer-v-n0ccwk` }),
    (ge = {
      opacity: 1,
      rotate: 0,
      rotateX: 0,
    ...
    ($ = _(
      o(function (e, t) {
        let r = n(null),
          i = t ?? r,
          a = te(),
          { activeLocale: o, setLocale: ee } = se();
        le();
        let { style: c, className: u, layoutId: d, variant: f, ...m } = Se(e),
          {
            baseVariant: re,
            classNames: h,
            ...
            setVariant: ce,
            variants: x,
          } = ae({ defaultVariant: `HK2sXlagE`, ref: i, variant: f, variantClassNames: Z }),
          S = Ce(e, x),
          C = v(X);
        return s(ne, {
          id: d ?? a,
            ...
            children: s(xe, {
              ...
              children: s(oe, {
                ...
                children: l(Y, {
                  ...m,
                  ..._,
                  __framer__presenceAnimate: ge,
                  __framer__presenceInitial: _e,
                  __perspectiveFX: !1,
                  __smartComponentFX: !0,
                  __targetOpacity: 1,
                  className: `${v(C, `framer-n0ccwk`, u, h)} framer-bmpgw8`,
    ...
    (we = $),
    ($.displayName = `Badge`),
    ($.defaultProps = { height: 38, width: 140 }),
    ce($, [{ explicitInter: !0, fonts: [] }, ...K, ...q], { supportsExplicitInterCodegen: !0 }),
    (Te = {
      exports: {
...
export { Te as __FramerMetadata__, we as default };
//# sourceMappingURL=PX9hIOIVM.CXQgJIfa.mjs.map
