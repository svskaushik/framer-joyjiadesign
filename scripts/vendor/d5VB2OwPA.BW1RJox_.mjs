...
import { a as E, c as D, o as O, s as k } from "./shared-lib.DsSu9Ft0.mjs";
function A(e, ...t) {
  let n = {};
  ...
  U = e(() => {
    (s(),
              ...
              children: a(I, {
                ...
                children: a(x, {
                  ...
                  children: a(u.a, {
                    ...C,
                    ...L,
                    className: `${v(q, `framer-1m27byo`, m, O)} framer-npfks`,
      ...
      m(V, {
        ...
        onjxKssWe7XChange: { changes: `jxKssWe7X`, type: C.ChangeHandler },
        gFmsDu1G9: { title: `Link`, type: C.Link },
      }),
      S(
        V,
        [
...
//# sourceMappingURL=d5VB2OwPA.BW1RJox_.mjs.map
